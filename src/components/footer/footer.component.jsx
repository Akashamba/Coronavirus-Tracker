...
const Footer = () => {
    return (
        <div>
            ...
            <Navbar className='footer' color="light"><NavbarText className='m-auto'>&copy; <a href="https://akashamba.netlify.app/" target="none" id="portfolio">Akash Ambashankar</a></NavbarText></Navbar>
